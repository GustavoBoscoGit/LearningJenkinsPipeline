pipeline{
    ...
    post{
        always{
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'cypress/report', reportFiles: 'htmlpublisher-wrapper.html', reportName: 'HTML Report', reportTitles: ''])
        }
    }
}