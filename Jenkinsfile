pipeline{
    ...
    post{
        always{
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, includes: '**/**', keepAll: true, reportDir: 'cypress/report', reportFiles: 'mochawesome.html', reportName: 'HTML Report', reportTitles: ''])
        }
    }
}